...
public class StoreManager {
    ...
    public static final String DB_FILE = System.getProperty("user.dir") + "\\data\\store.db";
    ...
    private StoreManager(String dbms, String dbfile) {
        ...
        ProductModel firstproduct = adapter.loadProduct(1);
        System.out.print(firstproduct);
    }
